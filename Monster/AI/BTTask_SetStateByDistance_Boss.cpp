...
#include "BTTask_SetStateByDistance_Boss.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "BehaviorTree/BehaviorTreeComponent.h"
#include "Monster/MonsterAIController.h"
#include "Monster/MonsterBase.h"

EBTNodeResult::Type UBTTask_SetStateByDistance_Boss::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	else if (Distance <= Monster->SkillAttackRange)
	{
		//몬스터 상태를 공격 상태로 바꾸기
		Monster->SetState(EMonsterState::Attack);
	}
